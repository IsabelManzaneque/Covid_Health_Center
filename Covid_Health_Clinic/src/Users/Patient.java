...
public class Patient extends Person {
    ...
    {
        return String.format("ID: %-10s Name: %-17s Phone number: %-10s  Birth date: %-10s Quarantine start date: %-10s",getID(),
        getName(), getNumber(), getBirthDate(),quarantineStartDate);
