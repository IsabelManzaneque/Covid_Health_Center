...
public class DataBase {
    ...
    public void addPeople()
    {
    	...
    	userManager.newPerson("patient", "Rober Fernandez","31589561J" , "625921265", "1993/01/23");
    ...
    public void addCitas()
    {
         ...
         testManager.addTest("40159367P","17452786X", "53902577F", "2021/04/27", "Antigens: quick");
         ...
         testManager.addTest("81739541T","97552381G", "13391319F", "2021/04/28", "Antigens: classic");
